      ...
      >
        <div className="relative w-auto my-6 mx-auto max-w-3xl">
          ...
          <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
            ...
            {/*body*/}
            <div className="bg-primary-200 rounded relative p-6 flex-auto">
                <button className='bg-mono-100 ' onClick={() => setShowModal(false)}>X</button>
                    ...
                    <form
                        onSubmit={async (values) => {
                            ...
                            if (data.status == '200') {
                                console.log('you verified your email!')
                            } else {
                                console.log('something went wrong')
                            }
                    }}>
                    <input type='string' name='code' label='code' />
                    <button className='bg-mono-800' type='submit'>Submit</button>
              </form>
            </div>
            {/*footer*/}
